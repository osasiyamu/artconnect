    ...
    return (
        <div style={{ color: 'black', marginTop: '40px', padding: '2rem' }}>
            ...
            <div style={{ textAlign: 'end' }}>
                <button className="btn btn-primary search justify-content-end" data-toggle="modal" data-target=".bd-example-modal-lg" onClick={handlePlaceOrder}>Place Order</button>
