    ...
    return (
        <div className='discover'>
            ...
            <div className="fixed-bottom" style={{ display: 'flex', justifyContent: 'flex-end', marginRight: '10px', marginBottom: '10px' }}>
                ...
                <a className="btn btn-primary align-item-end" data-bs-toggle="collapse" href="#languages" role="button" aria-expanded="false" aria-controls="languages" style={{ borderRadius: '50%', width: '50px', height: '50px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <i className="bi bi-globe-americas"></i>
                </a>
            </div>
