...
const TutorialFinal = () => {
    return ( 
        <div>
            ...
            <div className="d-flex ">
                ...
                <div className="details" style={{color: 'black'}}>
                    <div style={{margin: '10px'}}>
                        <h1 style={{fontSize: '3.5rem', fontFamily: "'Lobster', cursive"}}>Step 3:</h1>
            ...
            <button className="btn btn-primary tutorial"><a href='/artconnect/tutorial1' style={{color: 'white', textDecoration: 'none'}}><i class="bi bi-arrow-left-circle-fill">    </i>Previous Step</a></button>
                <button className="btn btn-primary tutorial"><a href='/artconnect/art' style={{color: 'white', textDecoration: 'none'}}>Finish Tutorial    <i class="bi bi-arrow-right-circle-fill"></i></a></button>
            </div>
