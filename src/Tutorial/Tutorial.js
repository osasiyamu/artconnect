    ...
    return ( 
        <div>
            ...
            <div className="d-flex ">
                ...
                <div className="details" style={{color: 'black'}}>
                    <div style={{margin: '10px'}}>
                        <h1 style={{fontSize: '3.5rem', fontFamily: "'Lobster', cursive"}}>Step 1:</h1>
            ...
            <div className="d-flex justify-content-end tutorial">
                <button className="btn btn-primary tutorial"><a href='/artconnect/tutorial1' style={{color: 'white', textDecoration: 'none'}}>Next Step     <i class="bi bi-arrow-right-circle-fill"></i></a></button>
            </div>
